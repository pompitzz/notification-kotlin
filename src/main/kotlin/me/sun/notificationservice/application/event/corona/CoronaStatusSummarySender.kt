...
import me.sun.notificationservice.application.sender.kakao.KakaoMessageSender
import me.sun.notificationservice.application.sender.kakao.model.KakaoMsgContent
import me.sun.notificationservice.application.sender.kakao.model.KakaoMsgListType
import me.sun.notificationservice.application.sender.kakao.model.KakaoMsgTextType
...
class CoronaStatusSummarySender(
    ...
    private fun sendKakao(coronaEventNotificationDto: CoronaEventNotificationDto, coronaStatusSummary: CoronaStatusSummary) {
        ...
        kakaoMessageSender.send(KakaoMsgTextType(text = "자세히(${URL.CORONA_STATUS})"), accessToken)
    }
